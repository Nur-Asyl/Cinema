...
public class CustomerProfileMenu {
    ...
    public CustomerProfileMenu(UserController userController, MovieController movieController, TicketController ticketController, OrderController orderController, Scanner scanner) {
    ...
    public void TicketMenu() {
        try {
            System.out.println("Your tickets: " + orderController.getAllOrders(userId));
        } catch (InputMismatchException e) {
